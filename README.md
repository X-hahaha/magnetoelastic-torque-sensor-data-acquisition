...
| 激光传感器 | PDL030-485 ×5 | 500us最快采样速度，RS485 / Modbus RTU 码输出 |
| 温度传感器 | 世敖世家 ×1 | 50ms响应速度，RS485 / Modbus RTU 码输出 |
| 帧长度 | 4,687,500 样点/通道 | 300 ms / 帧，相当于1000rpm的轴转5圈 |
| 帧大小 | ~18.75 MB | A/B 交织，每样点 4 字节，前两个字节为通道A，后两个字节为通道B |
